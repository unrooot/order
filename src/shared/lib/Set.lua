-- A set is a collection of items with no order and no duplicate elements. An
-- item either **is** or **is not** contained within a set.
-- Source: https://create.roblox.com/docs/scripting/luau/metatables#using-the-set-datatype
local Set = {}
Set.__index = Set
...
function Set:__add(otherSet): Set
	local result = Set.new()
...
function Set:__sub(otherSet): Set
	local result = Set.new()
	for entry: any in pairs(self) do
		result[entry] = true
	end
